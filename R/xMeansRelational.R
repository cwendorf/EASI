...
plotMeansRelational <- function(...,add=FALSE,main=NULL,ylab="Outcome",xlab="",conf.level=.95,line=NULL,rope=NULL,values=TRUE,pos=2,connect=NULL,ylim=NULL,digits=3,col="black",border=NA,offset=0,intervals=TRUE) {
