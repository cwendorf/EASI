...
plotStandardizedMeans.default <- plotStandardizedMeans.bss <- plotStandardizedMeans.wss <- function(...,main=NULL,ylab="Standardized Mean Difference",xlab="",mu=0,rope=NULL,conf.level=.95,values=TRUE,ylim=NULL,digits=3,pch=24,col="black") {
...
plotStandardizedMeans.formula <- function(formula,main=NULL,ylab="Standardized Mean Difference",xlab="",mu=0,rope=NULL,conf.level=.95,values=TRUE,ylim=NULL,digits=3,pch=24,col="black") {
