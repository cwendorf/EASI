...
plotMeanContrast <- function(...,main=NULL,digits=3,ylab="Mean Contrast",xlab="",mu=0,line=NULL,rope=NULL,conf.level=.95,values=TRUE,pos=2,ylim=NULL,add=FALSE,pch=17,col="black") {
