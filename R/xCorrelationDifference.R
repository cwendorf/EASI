...
plotCorrelationDifference.default <- function(CorrEst1,CorrEst2,main=NULL,line=NULL,rope=NULL,ylab="Correlation",xlab="",values=TRUE,ylim=NULL,digits=3,pch=17,col="black") {
