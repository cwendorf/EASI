...
plotCorrelationDifference.default <- function(CorrEst1,CorrEst2,main=NULL,ylab="Correlation",xlab="",slab="Mean Difference",values=TRUE,ylim=NULL,digits=3,pch=NULL,...) {
  ...
  .cipMain(results,main,ylab=ylab,xlab=xlab,mu=NULL,rope=NULL,values=values,ylim=ylim,digits=digits,connect=FALSE,pch=17,slab=slab)
}
