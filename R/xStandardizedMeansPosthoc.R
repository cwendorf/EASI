...
plotStandardizedMeansPosthocDiffogram <- function(...,main="Confidence Intervals for the Posthoc Standardized Mean Comparisons",ylab="",xlab="",conf.level=.95,ylim=NULL,pch=24,col=NULL) {
  dm <- .describeMeans(...)
  emp <- .estimateStandardizedMeansPosthoc(...,conf.level=conf.level)
