...
(RepeatedMoments) |> plotPairwiseDiffogram(RepeatedCorr, col = c("darkblue", "darkred"))
```
...
(RepeatedMoments) |> plotRelational(RepeatedCorr, col = c("darkred", "darkblue", "darkgoldenrod"))
```
...
(RepeatedMoments) |> plotPosthocDiffogram(RepeatedCorr, col = c("darkblue", "darkred"))
```
