---
title: "OneWay Alternative Summary Example"
description: >
...
```{r, OneWay-Summary-Summary}
(OneWaySummary) |> plotSummary()
```
...
(OneWaySummary) |> estimateContrast(contrast = c(2/3, -1/3, -1/3))
(OneWaySummary) |> plotContrast(contrast = c(2/3, -1/3, -1/3))
```
...
(OneWaySummary) |> estimateComplex(contrast1 = c(1/3, 1/3, 1/3), contrast2 = c(1, 0, 0), labels = c("GrandMean", "L1Only"))
(OneWaySummary) |> plotComplex(contrast1 = c(1/3, 1/3, 1/3), contrast2 = c(1, 0, 0), labels = c("GrandMean", "L1Only"))
```
...
```{r}
(OneWaySummary) |> testContrast(contrast = c(2/3, -1/3, -1/3))
(OneWaySummary) |> testComplex(contrast1 = c(1/3, 1/3, 1/3), contrast2 = c(1, 0, 0), labels = c("GrandMean", "L1Only"))
```
