...
(OneWayMoments) |> plotPairwiseDiffogram(col = c("darkblue", "darkred"))
```
...
(OneWayMoments) |> plotRelational(col = c("darkred", "darkblue", "darkgoldenrod"))
```
...
(OneWayMoments) |> plotPosthocDiffogram(col = c("darkblue", "darkred"))
```
