...
description: >
  This page examines a single-factor within-subjects (repeated measures) design using summary statistics input, adding data, color, and plausibility curves to plots of comparisons and contrasts.
