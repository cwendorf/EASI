---
title: "OneWay Data Exploration Example"
description: >
  This page builds exploratory data analysis plots using one-way (between-subjects) data.
...
(Outcome ~ Factor) |> plotData(main = "Data and Boxplots") |> addBoxes()
```
...
(Outcome ~ Factor) |> plotFrequencies(main = "Frequencies and Summary Statistics for the Data") |> addSummary()
```
