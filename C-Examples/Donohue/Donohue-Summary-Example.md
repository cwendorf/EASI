...
```
```r
plotMeans(DonohueSummary,ylab="Critical Thinking") # Donohue-Figure1.jpeg
```
...
```
```r
plotDifference(PostvsFollowup,DonohueCorr,ylab="Critical Thinking") # Donohue-Figure2.jpeg
```
...
```
```r
plotContrast(DonohueSummary,DonohueCorr,contrast=PrevsPostFollow,labels=c("Pretest","Post&Follow"),ylab="Critical Thinking") # Donohue-Figure3.jpeg
```
