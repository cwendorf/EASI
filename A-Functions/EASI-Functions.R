...
cipDifference <- function(results,main,ylab,xlab,rope) {
  ...
  par(mar=c(5,5,5,5))  
  plot(c(1,2,3),graph[,1],axes=FALSE,xaxs="i",yaxs="i",xaxt="n",xlim=c(.4,3.6),ylim=c(floor(min(graph[,2])/2)*2,ceiling(max(graph[,3])/2)*2),pch=c(15,15,17),cex=1.5,xlab="",ylab=ylab,main=main,las=1,cex.lab=1.3,bty="l")
