...
output:
  html_document:
    ...
    keep_md: TRUE
vignette: >
  %\VignetteIndexEntry{Combination Repeated Measures Data Application}
...
```{r,Combination-Repeated-ComparisonA}
...
```{r,Combination-Repeated-ComparisonB}
...
```{r,Combination-Repeated-ContrastA}
O1vsOthers <- c(-1,.5,.5)
...
```{r,Combination-Repeated-ContrastB}
