...
setwd(sourceDir)
render_toc("MixedSummaryTutorial.Rmd")
```
...
```{r,Mixed-ContrastB}
plotMeanContrast(MixedSummaryL1,MixedCorrL1,contrast=O1vsOthers,labels=c("Outcome1","Others"),conf.level=.99,rope=c(-2,2))
plotMeanContrast(MixedSummaryL2,MixedCorrL2,contrast=O1vsOthers,labels=c("Outcome1","Others"),conf.level=.99,rope=c(-2,2))
```
