...
estiamteStandardizedMeans(FactorialSummaryB2)
```
...
plotMeanContrast(FactorialSummaryB1,contrast=A1vsOthers,labels=c("A1","Others"),conf.level=.99,rope=c(-2,2))
plotMeanContrast(FactorialSummaryB2,contrast=A1vsOthers,labels=c("A1","Others"),conf.level=.99,rope=c(-2,2))
```
