...
setwd(sourceDir)
render_toc("RepeatedSummaryTutorial.Rmd")
```
...
plotMeanContrast(RepeatedSummary,RepeatedCorr,contrast=O1vsOthers,labels=c("Outcome1","Others"),conf.level=.99,rope=c(-2,2))
```
