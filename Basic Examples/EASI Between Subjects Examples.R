...
estimateGroupPairs(Outcome~Group)
testGroupPairs(Outcome~Group)
plotGroupPairs(Outcome~Group)

estimateGroupPairs(Outcome~Group,conf.level=.99)
testGroupPairs(Outcome~Group)
plotGroupPairs(Outcome~Group,mu=0,conf.level=.99)

# Analyses of Sets of Contrasts

estimateGroupContrasts(Outcome~Group)
testGroupContrasts(Outcome~Group)
plotGroupContrasts(Outcome~Group)

estimateGroupContrasts(Outcome~Group,conf.level=.99)
plotGroupContrasts(Outcome~Group,conf.level=.99)

estimateGroupContrasts(Outcome~Group,contrasts=contr.treatment)
testGroupContrasts(Outcome~Group,contrasts=contr.treatment)
plotGroupContrasts(Outcome~Group,contrasts=contr.treatment)

setcontrasts=contr.treatment
estimateGroupContrasts(Outcome~Group,contrasts=setcontrasts)
