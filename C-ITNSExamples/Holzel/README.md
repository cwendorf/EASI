...
The **Holzel** documents and files analyze and example of a two-factor mixed design, one between-subjects and one within-subjects factor (from _[ITNS](https://thenewstatistics.com/itns/ "Introduction to the New Statistics")_, Ch. 15).
...
The [**HOLZEL-SUMMARY-EXAMPLE.md**](./HOLZEL-SUMMARY-EXAMPLE.md) file uses summary statistics input.  
